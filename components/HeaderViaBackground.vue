                    ...
                    <div v-if="userDatas" class="flex justify-center lg:justify-between gap-5 p-5 pb-20 dark:text-white lg:px-12 md:items-start lg:py-40">
                        <div class="flex flex-col lg:flex-row items-center gap-8">
                            <div class="flex items-center flex-col gap-8">
                                ...
                                <div class="lg:hidden cursor-default" x-init="generateStar(user.rate_avg, 'starRes')">
                                    <div class="pointer-events-none" id="starRes"></div>
                                </div>
                            </div>
                        ...
                        <div class="hidden lg:flex flex-col text-2xl items-end" x-init="generateStar(user.rate_avg, 'demoHead')">
                            <p class="mb-7"><span class="ml-1">{{ PN.convertEnToPe(userDatas.case_count) }}</span> آگهی</p>
                            <div class="pointer-events-none" id="demoHead"></div>
                        </div>
                    </div>
                </div>
            </div>
