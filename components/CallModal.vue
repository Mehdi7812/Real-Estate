                ...
                <div v-click-out-side="closeModal" class="flex flex-col gap-3 w-[550px] bg-secondary dark:bg-white rounded-[26px] p-5 pt-0">
                    ...
                    <div class="w-full h-auto overflow-hidden transition-all duration-300">
                        <div class="flex flex-col items-center gap-5 p-2">
                            ...
                            <a :href="`propertyUser?user=${modalCallStore.userId}`" class="flex flex-col items-center p-4 gap-2">
                            ...
                            <!-- Call Btn -->
                            <a :href="`tel:${modalCallStore.userNumber}`" class="flex justify-center items-center gap-3 bg-[#0DA049] dark:text-white tracking-widest text-xl dark:bg-bluePrimary dark:hover:bg-bluePrimary/80 p-4 rounded-2xl w-full transition-all duration-300 hover:bg-[#0DA049]/50" href="tel:+989111111111">
                            ...
                            <!-- Star Person -->
                            <div class="flex flex-col items-center justify-center p-6 w-full rounded-2xl bg-[#F8C623]/80 gap-5">
