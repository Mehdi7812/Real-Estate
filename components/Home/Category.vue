<template>
    <section class="container -mt-[90px] lg:mt-0 m-auto p-5 mb-15 md:py-10 lg:px-12 lg:relative">
        <div class="py-10 flex flex-col gap-5 lg:flex-row lg:bg-primary lg:dark:bg-[#E6E6E6] lg:-top-[120px] lg:p-1 lg:rounded-2xl lg:justify-between lg:absolute lg:left-0 lg:right-0 lg:w-11/12 lg:m-auto">
            ...
            <NuxtLink :to="`/propertyCode?&${region ? 'region=' + region : ''}${estate_type ? '&estate_type=' + estate_type : ''}${unit_price__lte ? '&unit_price__lte=' + unit_price__lte : ''}${unit_price__gte ? '&unit_price__gte=' + unit_price__gte : ''}`" style="background-color: var(--primaryColor)" class="btn hover:opacity-80 w-full text-[17px] lg:w-1/6 py-8">جستجوی ملک</NuxtLink>
        </div>
