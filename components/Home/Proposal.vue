                            ...
                            <div class="py-3 flex gap-4 flex-col lg:min-w-[270px] lg:pr-3 lg:justify-center xl:w-1/2">
                                ...
                                <div class="flex items-center gap-3 justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm flex flex-col"><span v-html="convertDatas.getNumber(data.unit_price)" class="text-3xl font-semibold mx-3 whitespace-nowrap"> </span> تومان</p>
                                    </div>
                                
                                    <!-- پیش پرداخت -->
                                    <p v-if="data.pre_payment_status" class="flex items-center justify-center flex-wrap gap-1 text-xs lg:text-base text-graytext whitespace-nowrap">پیش پرداخت : <span><span v-html="convertDatas.getNumber(data.pre_payment)" class="text-white dark:text-black lg:text-lg font-bold"> </span> تومان</span></p>
                                </div>
