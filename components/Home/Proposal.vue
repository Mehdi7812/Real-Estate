            ...
            <div class="container m-auto p-5">
                <div class="flex justify-between">
                    ...
                    <div class="flex gap-2">
                        <div>
                            <RouterLink to="propertyCode.html?special=true" style="background-color: var(--primaryColor);" class="group hover:opacity-80 p-3 lg:p-5 justify-center flex items-center rounded-lg hover:bg-hoverPrimaryOrange transition-all duration-300">
                ...
                <div x-data="proposal" class="swiper swiperProposal">
                    ...
                    <div class="swiper-wrapper">
                        <div v-for="data in dataRes" :key="data.id" class="swiper-slide">
                            <div x-init="swiperImgRun" class="postCard bg-secondary dark:bg-white rounded-2xl py-2 px-3 group lg:flex xl:h-full cursor-pointer">
                                <div class="swiper swiperProposalImg1 rounded-2xl overflow-hidden xl:w-1/2">
                                    <div class="swiper-wrapper">
                                        ...
                                        <!-- <template x-if="data.media.length==0">
                                            <div class="swiper-slide">
                                                <div class="relative rounded-2xl overflow-hidden h-72 lg:h-full">
                                                    <a :href="`propertyDetails.html?id=${data.id}`">
                                ...
                                <div class="py-3 flex gap-4 flex-col lg:min-w-[270px] lg:pr-3 lg:justify-center xl:w-1/2">
                                    ...
                                    <a :href="`propertyDetails.html?id=${data.id}`" class="flex gap-8 flex-wrap gap-y-3">
                                    ...
                                    <a :href="`propertyDetails.html?id=${data.id}`" class="flex items-center gap-3 justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-sm"><span v-html="getNumber(data.unit_price)" class="text-3xl font-semibold mx-3 whitespace-nowrap"> </span> تومان</p>
                                        </div>
                                    ...
                                    <div class="text-right -mb-[48px]">
                                        <a :href="`propertyUser.html?user=${data.user_id}`">
                                        ...
                                        <div style="background-color: var(--primaryColor-20)" class="flex justify-between items-center relative -top-[43px] right-5 bg-primary dark:bg-whiteSecondary w-11/12 md:w-1 h-[43px] group-hover:w-11/12 transition-all duration-300 rounded-tl-[21.5px] rounded-bl-[21.5px] overflow-hidden">
                                            <a :href="`propertyUser.html?user=${data.user_id}`" class="flex px-10 whitespace-nowrap flex-col">
