                                    ...
                                    <div class="flex items-center h-[70px]">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <p class="text-sm flex flex-nowrap items-center">
                                                <p v-html="convertDatas.getNumber(data.unit_price)" class="whitespace-nowrap text-2xl font-bold ml-3"></p>
                                            ...
                                            <div class="flex flex-nowrap items-center text-base">
                                                <p class="whitespace-nowrap font-normal ml-3 text-graytext line-through">230میلیارد</p>
