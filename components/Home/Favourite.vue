<template>
    <section class="mb-12 dark:text-white md:py-10 lg:px-12 lg:mb-0 lg:pb-0">
        <div x-data="favouritePlaces" class="container m-auto p-5">
            <!-- خرید ویلاهای جنگلی -->
            <a href="propertyCode.html?jungle=true" class="relative my-28 rounded-xl overflow-hidden hidden sm:block lg:mt-10">
            ...
            <div class="relative my-20 rounded-xl overflow-hidden sm:hidden">
                <a href="propertyCode.html?beach=true" class="block w-full h-[117px] bg-no-repeat bg-right" style="background-image: url(favImg2.webp);">
                    <div style="background: linear-gradient(to right, var(--primaryColor) 55%, transparent)" class="absolute left-0 top-0 bottom-0 w-5/6 bg-gradient-to-r from-primaryOrange via-primaryOrange after:from-bluePrimary after:via-bluePrimary z-10"></div>
                    <div class="flex items-center absolute left-[10%] top-0 bottom-0 z-20 cursor-pointer">
            ...
            <div class="hidden lg:grid grid-cols-4 grid-rows-2 gap-5" style="direction: ltr;">
                <a href="propertyCode.html?city=چمستان" class="relative cursor-pointer flex justify-center items-center h-64 rounded-xl overflow-hidden bg-cover bg-no-repeat" style="background-image: url(chamestan.webp);">
                ...
                <a href="propertyCode.html?city=سرخ رود" class="relative cursor-pointer flex justify-center items-center h-64 rounded-xl overflow-hidden bg-cover bg-no-repeat" style="background-image: url(sorkhRood.webp);">
                ...
                <a href="propertyCode.html?city=نوشهر" x-data="favouritePlaces('نوشهر')" class="col-span-2 row-span-2 relative cursor-pointer rounded-xl overflow-hidden bg-cover bg-no-repeat" style="background-image: url(noshahr.webp);">
                ...
                <a href="propertyCode.html?city=نور" class="relative cursor-pointer flex justify-center items-center h-64 rounded-xl overflow-hidden bg-cover bg-no-repeat" style="background-image: url(noor.webp);">
                ...
                <a href="propertyCode.html?city=متل قو" class="relative cursor-pointer flex justify-center items-center h-64 rounded-xl overflow-hidden bg-cover bg-no-repeat" style="background-image: url(motelGhoo.webp);">
            ...
            <a href="propertyCode.html?beach=true" class="hidden relative my-24 rounded-xl overflow-hidden lg:block">
            ...
            <div class="swiper swiperFavourite lg:!hidden">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide"> 
                        <a href="propertyCode.html?city=نور" class="h-72 bg-no-repeat bg-cover bg-center rounded-xl overflow-hidden flex flex-col justify-end pr-5 pb-3 after:bg-gradient-to-t after:from-black50 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-16 after:rounded-b-[12px]" style="background-image: url(noor.webp);">
                    ...
                    <div class="swiper-slide">
                        <a href="propertyCode.html?city=سرخ رود" class="h-72 bg-no-repeat bg-cover bg-center rounded-xl overflow-hidden flex flex-col justify-end pr-5 pb-3 after:bg-gradient-to-t after:from-black50 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-16 after:rounded-b-[12px]" style="background-image: url(sorkhRood.webp);">
                    ...
                    <div class="swiper-slide">
                        <a href="propertyCode.html?city=نوشهر" class="h-72 bg-no-repeat bg-cover bg-center rounded-xl overflow-hidden flex flex-col justify-end pr-5 pb-3 after:bg-gradient-to-t after:from-black50 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-16 after:rounded-b-[12px]" style="background-image: url(noshahr.webp);">
